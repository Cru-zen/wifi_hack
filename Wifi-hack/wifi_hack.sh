...
if [[ $int  == ""  ]]; then 
	echo -ne "\n"
	echo -ne "${red}You have to type your interface [!] ${reset}"
	echo -ne "\n"
	sleep 1
	ifc
fi
...
'''
echo -ne "\n"
echo -ne "c o d e d by${red} Cru-zen${reset} | insta : ${red}anant_singh_rathore${reset} | github : ${red}Cru-zen${reset}
"
}
banner(){
echo '''
...
if [[ $bss == "" || $ch == "" ]]; then
echo -ne "\n"
echo -ne "${red}You have to type The BSSID AND THE CHANNEL  [!] ${reset}"
echo -ne "\n"
sleep 1
...
if [[ $pass == "" ]]; then 
echo -ne "\n"
	echo -ne "${red}you have to type the passlist  [!] ${reset}"
	echo -ne "\n"
	sleep 1
wordd
